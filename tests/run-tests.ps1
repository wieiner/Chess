...
function New-TestRegistry {
    ...
    return @(
        ...
        [PSCustomObject]@{ Name = "ChessGameRecordsContractTests"; Suites = @("All", "Managed", "Chess2D"); Project = "tests\ChessGameRecordsContractTests\ChessGameRecordsContractTests.csproj"; Exe = "tests\ChessGameRecordsContractTests\bin\x64\Release\net8.0\ChessGameRecordsContractTests.exe"; Arguments = @(); IsOnline = $false; IsBenchmark = $false },
        [PSCustomObject]@{ Name = "Chess2DWorkflowContractTests"; Suites = @("All", "Managed", "Chess2D"); Project = "tests\Chess2DWorkflowContractTests\Chess2DWorkflowContractTests.csproj"; Exe = "tests\Chess2DWorkflowContractTests\bin\x64\Release\net8.0-windows\Chess2DWorkflowContractTests.exe"; Arguments = @(); IsOnline = $false; IsBenchmark = $false },
        [PSCustomObject]@{ Name = "ChessUciSubprocessTests"; Suites = @("All", "Managed", "Chess2D"); Project = "tests\ChessUciSubprocessTests\ChessUciSubprocessTests.csproj"; Exe = "tests\ChessUciSubprocessTests\bin\x64\Release\net8.0-windows\ChessUciSubprocessTests.exe"; Arguments = @(); IsOnline = $false; IsBenchmark = $false },
        [PSCustomObject]@{ Name = "ModelAssetsContractTests"; Suites = @("All", "Managed"); Project = "tests\ModelAssetsContractTests\ModelAssetsContractTests.csproj"; Exe = "tests\ModelAssetsContractTests\bin\x64\Release\net8.0\ModelAssetsContractTests.exe"; Arguments = @(); IsOnline = $false; IsBenchmark = $false },
        [PSCustomObject]@{ Name = "ModelAssetsWpfContractTests"; Suites = @("All", "Managed"); Project = "tests\ModelAssetsWpfContractTests\ModelAssetsWpfContractTests.csproj"; Exe = "tests\ModelAssetsWpfContractTests\bin\x64\Release\net8.0-windows\ModelAssetsWpfContractTests.exe"; Arguments = @(); IsOnline = $false; IsBenchmark = $false },
        ...
        [PSCustomObject]@{ Name = "RubikStateContractTests"; Suites = @("All", "Managed", "Rubik"); Project = "tests\RubikStateContractTests\RubikStateContractTests.csproj"; Exe = "tests\RubikStateContractTests\bin\x64\Release\net8.0\RubikStateContractTests.exe"; Arguments = @(); IsOnline = $false; IsBenchmark = $false },
