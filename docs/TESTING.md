...
- They prove P2E CoreCell stack storage and stack-aware anchors. They do not prove final fusion/implosion behavior, knockback/reserve, contested anchor resolution, or ritual Rubik layer-turn legality yet.
- They do not implement or prove fusion entities, resonance, color/permutation, implosion mechanics, or Rubik layer turns moving stacks yet.
...
The next recommended testing milestone is P2F: fusion/implosion contract tests on top of the CoreCell stack model.
