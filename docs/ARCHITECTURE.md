...
- `Chess3DEngine.dll`: 8x8x8 cube board state, P2A single-side movement/capture contracts, draft six-side setup, and Rubik-style layer rotations for cube chess.
