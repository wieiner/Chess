...
CUDA remains optional in CI and in the default local build. The next recommended project stage is P2F: fusion / implosion mechanics on top of the P2E CoreCell stack model.
